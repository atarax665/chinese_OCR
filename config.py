...
class chineseocr_config(object):
    def __init__(self):
        ...
        self.chineseocr_mod_file = os.path.join(
            self.mod_dir, 'chineseocr_densectc.onnx')
        self.chineseocr_words_file = os.path.join(
            self.mod_dir, 'keywords_chinese.dict')
        self.chineseocr_words_str = get_keyword_str(self.chineseocr_words_file)
        self.detect_mod_path = os.path.join(
            self.mod_dir, 'text_detect_dbnet.onnx')
